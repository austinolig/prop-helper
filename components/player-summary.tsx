import { GameLog, PlayersTable } from "@/app/types";
		...
		<div className="flex flex-wrap gap-8 bg-white/5 p-4 rounded-lg">
			...
			{stats && (
				<div className="flex-1 min-w-[250px]">
					<h3>Season Stats ({stats.gamesPlayed} games)</h3>
					<div className="mt-2 flex justify-around w-full gap-4 flex-wrap text-center text-xs text-gray-500">
						<div>
							<div>PPG</div>
